...
const Billing: React.FC = () => {
  const { registerPurchase, errors, validations, setValidations } =
    usePurchaseContext()
  ...
  const handleSave = () => {
    ...
    const isValid =
      ...
      validateFields(
        ...
        validateStates(validations, ['emailBillingValid', 'termBillingAcept']),
      )
            ...
            <div className="sm:overflow-scroll sm:h-[30rem] sm:px-2 space-y-4">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-1 md:grid-cols-2 gap-2">
                <SelectInput
                  ...
                  value={
                    registerPurchase.tipopersona_factura === undefined ||
                    registerPurchase.tipopersona_factura === null
                      ? ''
                      : registerPurchase.tipopersona_factura
                  }
                  obligatory
                  options={[
              ...
              <div className="flex items-start space-x-1">
                ...
                <InputCheck
                  ...
                  onChange={() =>
                    setValidations((prev: any) => ({
                      ...prev,
                      termBillingAcept: !validations.termBillingAcept,
                    }))
                  }
