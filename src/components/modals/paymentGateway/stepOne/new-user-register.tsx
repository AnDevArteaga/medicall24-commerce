            ...
            <div className="bg-white p-6 rounded-lg shadow-lg w-96 relative">
                ...
                {statusRegister === "success" && (
                    <div className="text-center">
                        {/* Sección de activación de cuenta - OCULTA/COMENTADA */}
                        {/* {!isActivated
                            ? (
                                <>
                        ...
                        {/* Mostrar directamente el mensaje de registro exitoso con botón Siguiente */}
                        <>
                            <h3 className="text-lg font-semibold text-gray-800">
                                Registro exitoso
                            </h3>
                ...
                {statusRegister === "error" && (
                    <div className="text-center">
                        ...
                        <p className="mt-4 mb-6 text-gray-600">
                            {errors.statusRegister ||
                                "Ocurrio un error al registrar tu cuenta ¿Tus datos son válidos?"}
                        </p>
