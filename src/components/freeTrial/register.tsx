...
const StepOne: React.FC = () => {
    ...
    return (
        <div className="bg-white rounded-lg p-6 w-full" onChange={() => setIsDirty(true)}>
            <form className="space-y-4" autoComplete="off">
                {/* Fila 1 */}
                <div className="grid grid-cols-2 sm:grid-cols-1 xs:grid-cols-1 gap-4 sm:gap-0 xs:gap-0">
                    <div>
                        <SelectInput
                ...
                <div className="grid grid-cols-4 sm:grid-cols-1 md:grid-cols-2 xs:grid-cols-1 gap-3">
                    <Input
                        label="Primer Nombre"
                        name="name1"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 xs:grid-cols-1 gap-3">
                    <div>
                        <Input
                ...
                {!isRegistered && (
                    <div className="grid grid-cols-2 sm:grid-cols-1 md:grid-cols-2 xs:grid-cols-1 gap-3">
                        <PasswordInput
                            label="Contraseña"
                            name="password"
            ...
            <div className="flex justify-center items-center mt-5">
                <ButtonForm
                    ...
                    text="Registrarse"
                    disabled={!validateFields(registerData, [
                        "user.identification",
                        "user.typeId",
                        "user.name1",
                        "user.lastName1",
