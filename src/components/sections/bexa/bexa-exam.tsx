...
const BexaExam: React.FC<BexaExamProps> = ({ onVerProducto }) => {
    ...
    return (
        <section className="grid grid-cols-2 -mt-12 lg:grid-cols-2 xl:grid-cols-2 md:grid-cols-1 sm:grid-cols-1 xs:grid-cols-1 xs:gap-8 sm:gap-8 gap-0 items-center px-32 lg:px-32 xl:px-32 md:px-8 sm:px-8 xs:px-8 py-16 h-auto bexa">
            {/* Contenido izquierdo */}
            <div className="space-y-6 sm:space-y-6 lg:space-y-6 xl:space-y-6 md:flex md:flex-col lg:block xl:block md:p-24 lg:p-0 xl:p-0 md:items-center lg:items-start xl:items-start sm:flex sm:flex-col">
                <div className="space-y-4 w-3/4 lg:w-3/4 xl:w-3/4 md:w-full sm:w-full xs:w-full">
    ...
    detectar masas en la mama." />
                ...
                <div className="space-y-2">
                    ...
                    {/* Botón de compra */}
                    <div className="flex flex-col w-1/2 lg:w-1/2 xl:w-1/2 sm:w-full xs:w-full md:w-full">
                        <ButtonBuy
                            text="Comprar"
            ...
            <div className="w-full">
                <div className="relative bg-gray-100 sm:hidden rounded-2xl overflow-hidden max-w-full md:max-w-full shadow-lg">
                    <video
                        className="w-full h-auto rounded-2xl"
                        src={videoBexa}
                        autoPlay
