...
const MobileMenu: React.FC<Props> = ({
  ...
  return (
    <>
      <button
        className="w-10 h-10 flex justify-center items-center relative lg:hidden xl:hidden"
      ...
      <div
        className={`absolute top-0 mt-16 left-0 w-full bg-white text-black z-50 overflow-hidden transition-all duration-1000 ease-in-out lg:hidden xl:hidden ${
        ...
        >
          ...
          <li className="flex justify-center mt-6">
            <a
              ...
              className="bg-primary text-white px-6 py-3 rounded-lg font-semibold transform transition hover:scale-105 text-lg hover:text-white"
              target="_blank"
              onClick={() => setMenuOpen(false)}
            >
              Acceso a Médicos
