    ...
    return (
        <div className="bg-white rounded-lg p-6 w-full">
            ...
            <div className="flex justify-center items-center">
                ...
                <div className="grid grid-cols-4 sm:grid-cols-1 xs:grid-cols-1 gap-3 sm:gap-0 xs:gap-0">
                    <Input
                        label="Primer Nombre"
                        name="name1"
                ...
                <div className="grid grid-cols-1 lg:grid-cols-1 xl:grid-cols-1 sm:grid-cols-1 md:grid-cols-1 gap-3 xs:gap-0 sm:gap-0 xs:grid-cols-1">
                    <div>
                        <Input
                ...
                {!isRegistered && (
                <div className="grid grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 sm:grid-cols-1 md:grid-cols-2 gap-3 xs:gap-0 sm:gap-0 xs:grid-cols-1">
                    <PasswordInput
                        label="Contraseña"
                        name="password"
