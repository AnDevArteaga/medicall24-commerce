...
const Bexa: React.FC = () => {
    ...
    const { producto, seleccionarProducto, limpiarProducto } = useProductoSeleccionado();
    ...
    const schema = {
        ...
        "@type": "MedicalTest",
        "name": "Examen BEXA",
        "description": "Examen BEXA para detectar masas en mama. Sin dolor, sin radiación, con resultados inmediatos.",
        "medicalSpecialty": "Oncología",
        "targetPopulation": "Mujeres",
        "url": "https://medicall24.com.co/Examen-bexa"
    };

    return (
        <>
            <SEO
                title="Examen BEXA | Detección de Masas en Mama | Medicall24"
                description="Examen BEXA para detectar masas en mama. Sin dolor, sin radiación, con resultados inmediatos. Agenda tu cita en Medicall24."
                keywords="examen bexa, detección masas mama, examen de seno, cáncer de mama, detección temprana, mamografía alternativa, salud de la mujer"
                url="https://medicall24.com.co/Examen-bexa"
                schema={schema}
            />
            <Layout title="Medicall24 | Examen Bexa">
            <main className="flex flex-col min-h-screen">
                <BexaExam onVerProducto={openModalProduct} allies={allies} />
                {/* <BexaPackage onVerProducto={openModalProduct} allies={allies} /> */}
                <Allies items={allies} onSelect={handleSelectAlly} type="carousel" />
                <Testimonials />
            </main>
